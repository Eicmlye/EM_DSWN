...
if __name__ == "__main__":
    ...
    ## EM COMMENT: my GPU memory is too small for 256 crop-size
    opt.crop_size = 64

    ## if you are gonna continue train pre-trained model, activate this block
    #""" # comment this line to activate the block below
    opt.pre_train = False
    opt.load_name = './RunLocal/DataSaved/230124_115741_train10Epochs/DSWN_best_epoch8_bs8_mu0_sigma30.pth'
